...
const agregarProducto = () => {
    ...
    let productoNuevo = crearProducto(tipoProducto, nombre, color, talla, cantidad);
...
const filtrarInventario = (tipo) => {
    let productosFiltrados = inventario.filter((producto) => producto.tipo.toLowerCase() === tipo.toLowerCase());
...
// Mostrar inicialmente el inventario al cargar la página
mostrarInventario(inventario);
